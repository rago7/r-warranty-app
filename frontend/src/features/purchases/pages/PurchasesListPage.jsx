...
import FiltersBar from "../../receipts/components/FiltersBar.jsx";
        ...
        <div>
            <div className="page-heading mb-3">
                ...
                <div className="actions">
                    <Link to="/purchases/new" className="btn btn-accent">Add purchase</Link>
                </div>
            </div>
            ...
            {isLoading ? (
                ...
                <div className="rounded-lg border border-[rgb(var(--danger)/0.3)] bg-[rgb(var(--danger)/0.1)] p-4 text-[rgb(var(--danger))]">
                    Failed to load purchases: {error?.message || 'Unknown error'}
                </div>
            ) : items.length === 0 ? (
                ...
                <div className="receipts-list">
                    {items.map((r) => (
                        <PurchaseCard key={r.id} purchase={r} />
                    ))}
                </div>
            )}
